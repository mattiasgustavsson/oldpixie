...
Platform_Win32_Screen_D3D9::Platform_Win32_Screen_D3D9(struct HWND__* windowHandle, bool fullscreen, int screenX, int screenY, int screenWidth, int screenHeight, bool interpolationMode, int monitor):
