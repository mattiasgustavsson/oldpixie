...
MAKE_GUID( GUID_IDirectDraw2, 0xB3A6F3E0,0x2B43,0x11CF,0xA2,0xDE,0x00,0xAA,0x00,0xB9,0x33,0x56 );

//*** Constructor ***

Platform_Win32_Screen_DDraw::Platform_Win32_Screen_DDraw(struct HWND__* windowHandle, bool fullscreen, int screenX, int screenY, int screenWidth, int screenHeight, int monitor):
...
bool Platform_Win32_Screen_DDraw::Setup()
	...
	ddrval=ddrawObject->QueryInterface(GUID_IDirectDraw2,reinterpret_cast<void**>(&directDraw_));
	ddrawObject->Release();
	if (FAILED(ddrval))
		{
