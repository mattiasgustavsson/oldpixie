...
class Platform_Win32_Screen_D3D9:public Platform_Win32_Screen_Technology
	...
	public:
		Platform_Win32_Screen_D3D9(struct HWND__* windowHandle, bool fullscreen, int screenX, int screenY, int screenWidth, int screenHeight, bool interpolationMode, int monitor );
