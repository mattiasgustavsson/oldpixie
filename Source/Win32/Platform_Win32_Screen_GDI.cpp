...
Platform_Win32_Screen_GDI::Platform_Win32_Screen_GDI(struct HWND__* windowHandle, bool fullscreen, int screenX, int screenY, int screenWidth, int screenHeight, int monitor):
