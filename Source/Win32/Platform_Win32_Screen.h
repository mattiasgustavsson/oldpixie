...
class Platform_Win32_Screen:public Platform_Screen, PlatformEventListener
	...
	public:
		...
		virtual void SetCrtMode(bool enabled);

		virtual bool GetCrtMode();
	...
	private:
		...
		static int __stdcall MonitorEnumProc( struct HMONITOR__* hMonitor, struct HDC__* hdcMonitor, struct tagRECT* lprcMonitor, long dwData );

	private:
		static unsigned int DebugFontData[];
